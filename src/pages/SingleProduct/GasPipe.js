...
import imgone from "./pipe 2.jpg";
import imgtwo from "./Pipe.jpg";
import imgthree from "./pipee.jpg";
import imgfour from "./Pipe.jpg";
...
const GasPipe = () => {
  ...
  const getData = async (id) => {
    const res = await axios.get(`${site}/products/63e161cee44b90b4668e4f2a`);
    const data = res.data;
    setData(data);
  };
  useEffect(() => {
                        ...
                        <div className="farmart-container">
                          ...
                          <div className="summary entry-summary">
                            <div className="entry-summary-content">
                              <ul className="site-breadcrumb">
                                ...
                                <li>
                                  <span>
                                    ...
                                    {/* ICONIC CARE - Gas Safety Device - Auto Cut
                                    Off - Gas Leakage Detector (for LPG
                                    Cylinders) */}
                                  </span>
                                </li>
                              </ul>
                              ...
                              {/* <div className="unit-text">{data.Weight}</div> */}
                              <p className="price">
                              ...
                              <div className="woocommerce-product-details__short-description">
                                <ul className="farmart-list">
                                  ...
                                  <li>
                                    <b>Specification Met:</b>&nbsp; {data.Certification}
                                  </li>
                                </ul>
                              </div>

                              <div className="cart" enctype="multipart/form-data">
