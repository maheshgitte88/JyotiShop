...
import imgone from "./gasSever.jpg";
import imgtwo from "./gasSever2.jpg";
import imgthree from "./GasSeverThree.jpg";
import imgfour from "./GasSeverFour.jpg";
...
const GasSever = () => {
  ...
  const getData = async (id) => {
    const res = await axios.get(`${site}/products/63e161cee44b90b4668e4f27`);
    const data = res.data;
    setData(data);
  };
  useEffect(() => {
