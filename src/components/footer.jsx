...
import footerBG from "../img/footer/footerBG.png";
      ...
      <footer id="colophon" className="site-footer">
        <div className="footer-infor">
          <div className="farmart-container">
            <div className="footer-infor__wrapper">
              <div className="footer-infor__item">
                <div className="footer-infor__image">
                  <span className="farmart-svg-icon">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 34.002 34"
                    >
                      <defs></defs>
                ...
                <div className="footer-infor__content">
                  <div className="footer-infor__content--title">
                    Free Shipping
                  </div>
                  <div className="footer-infor__content--desc">
        ...
        <div className="footer-widgets widgets-area">
          <div className="farmart-container">
            <div className="row-flex">
              <div className="footer-widgets-area-diff footer-widgets-area col-flex col-flex-xs-12 col-flex-sm-7 col-flex-md-6">
                <div
                  id="custom_html-4"
                ...
                >
                  ...
                  <div className="textwidget custom-html-widget">
                    Jyoti Gas Safety Device is the ultimate solution for
                    ensuring the safety of your home and loved ones.
                  </div>
                </div>
              </div>

              <div className="footer-widgets-area-2 footer-widgets-area col-flex col-flex-xs-12 col-flex-sm-4 col-flex-md-4">
                <div id="text-1" className="widget widget_text">
                  ...
                  >
                    <div className="textwidget custom-html-widget">
                      <ul className="footer-widget-description">
                        <li>
                          <span
                            className="farmart-svg-icon"
                            style={{ color: "#d7532d" }}
                          >
                            <i
                          ...
                          <span className="text">dasgroup.sgsd@gmail.com</span>
                        </li>
                        <li>
                          <span className="farmart-svg-icon">
                            <i
                          ...
                          <span className="text">8007800010</span>
                        </li>
                      </ul>
                    </div>
                  </div>
        ...
        <div className="footer-main site-info">
          <div
            className="farmart-container"
            style={{ justifyContent: "center" }}
          >
            <div className="footer-items">
              <div className="copyright">
                ©2023 Copyrights Jyoti Gas Safety Device. All rights reserved
              </div>
            </div>
          </div>
        </div>
